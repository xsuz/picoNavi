...
/* SPI pin assignment */
#define PIN_SPI0_MISO_DEFAULT 16
#define PIN_SPI0_CS_DEFAULT 17
#define PIN_SPI0_SCK_DEFAULT 18
#define PIN_SPI0_MOSI_DEFAULT 19
...
constexpr uint8_t CMD1(1);           /* SEND_OP_COND (MMC) */
constexpr uint8_t ACMD41(0x80 + 41); /* SEND_OP_COND (SDC) */
...
constexpr uint8_t ACMD13(0x80 + 13); /* SD_STATUS (SDC) */
...
constexpr uint8_t CMD23(23);         /* SET_BLOCK_COUNT (MMC) */
constexpr uint8_t ACMD23(0x80 + 23); /* SET_WR_BLK_ERASE_COUNT (SDC) */
constexpr uint8_t CMD24(24);         /* WRITE_BLOCK */
constexpr uint8_t CMD25(25);         /* WRITE_MULTIPLE_BLOCK */
constexpr uint8_t CMD32(32);         /* ERASE_ER_BLK_START */
constexpr uint8_t CMD33(33);         /* ERASE_ER_BLK_END */
constexpr uint8_t CMD38(38);         /* ERASE */
